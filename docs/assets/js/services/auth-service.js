import { firebaseConfig, auth, db } from '../config/firebase.js?v=2.0.0';
import { DEFAULT_GOLD_RATES } from '../core/constants.js?v=2.0.0';
import { state } from '../core/state.js?v=2.0.0';
import { getStoreSettings, getGoldRates } from './data-service.js?v=2.0.0';
